...
Source installations keep optional native extension builds configurable.
Set any of these to `0` before installation to skip that optional native extension:
